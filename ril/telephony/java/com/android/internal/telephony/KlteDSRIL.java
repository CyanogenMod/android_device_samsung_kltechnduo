...
/**
 * RIL customization for Galaxy S5 Dual Sims (Lollipop) devices
 *
 * {@hide}
 */
public class KlteDSRIL extends RIL {

    private static final int RIL_REQUEST_DIAL_EMERGENCY = 10001;
    private static final int RIL_UNSOL_ON_SS_KLTE = 11055;

    private boolean mIsGsm = false;

    public KlteDSRIL(Context context, int networkMode, int cdmaSubscription) {
        super(context, networkMode, cdmaSubscription, null);
        mQANElements = 6;
    }

    public KlteDSRIL(Context context, int preferredNetworkType,
